...
const requireComponent = require('../component/require');
const configurable = requireComponent('configurable.js');
const extend = requireComponent('extend');
const escapeRe = requireComponent('escape-regexp');
